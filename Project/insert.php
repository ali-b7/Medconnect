...
if (isset($_POST['u_username']) && isset($_POST['u_password'])) :
    ...
    $sql = "INSERT INTO `doctors` (`username`, `password`, `email_address`, `first_name`, `last_name`, `institution`) VALUES ('$username', '$password', '$first_name', '$last_name', '$institution', '$email_address')";
